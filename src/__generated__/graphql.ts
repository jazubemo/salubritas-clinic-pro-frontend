...
export type DoctorsQuery = { doctors: Array<{ email: string | null, firstName: string, lastName: string, clinicMemberships: Array<{ shifts: Array<{ daysOfWeek: Array<number>, endTime: string, startTime: string }> | null }> }> };
