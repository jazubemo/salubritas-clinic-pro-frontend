...
export type GetMeQuery = { getMe: { _id: string, authId: string, clinicRoles: unknown, dni: string, email: string | null, firstName: string, lastName: string, status: string } | null };
...
export type User = {
  ...
  clinicRoles: Scalars['JSON']['output'];
